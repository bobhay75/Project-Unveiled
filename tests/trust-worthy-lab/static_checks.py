...
assert root_htaccess.count("RewriteCond %{REQUEST_URI} !^/truth/lab(?:/|$) [NC]") == 2, "root method rules must delegate the lab to its child 405 policy so Allow headers survive"
