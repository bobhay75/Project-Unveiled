...
<main>
<section class="priority"><div><div class="eyebrow">TODAY'S CONTROL POINT</div><h2><?= $pending>0 ? 'Moderate reader submissions first' : ($activeDrafts>0 ? 'Review the active campaign draft' : 'Run an attributed traffic review') ?></h2><p><?= $pending>0 ? 'Nothing appears publicly until you approve it.' : ($activeDrafts>0 ? 'A quality-approved campaign is waiting for owner review.' : 'Generate the next evidence-based campaign move without treating direct traffic as a known source.') ?></p></div><a class="primary" href="<?= $pending>0?'/owner/funnel-servant/?tab=community':($activeDrafts>0?'/owner/funnel-servant/campaign-studio.php':'/owner/funnel-servant/?tab=autopilot') ?>">Open priority</a></section>
