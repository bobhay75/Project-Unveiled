...
?><!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1"><meta name="description" content="Project Unveiled: Truth on Trial. Claims are investigated with the Trust-Worthy method. Inspect the evidence. You be the judge."><title>Today's Truth Trial | Project Unveiled</title><link rel="stylesheet" href="/truth/truth-worthy.css"></head><body><header class="topbar"><div class="wrap nav"><a class="brand" href="/truth/">PROJECT UNVEILED <span>TRUTH ON TRIAL</span></a><nav class="navlinks"><a href="/truth/">Truth Home</a><a href="/truth/#ask">Ask a Question</a></nav></div></header><main>
<?php if ($trial === []): ?>
<section class="hero"><div class="wrap"><div class="eyebrow">Truth on Trial · Powered by Trust-Worthy</div><h1>THE NEXT CLAIM IS BEING CHOSEN.</h1><p>The Truth on Trial desk is live. No reviewed case has been published through the new desk yet.</p><div class="manifesto"><strong>QUESTION EVERYTHING!</strong><br>When the evidence trail is ready, it will appear here. <strong>YOU BE THE JUDGE.</strong></div></div></section>
<?php else: ?>
<section class="hero"><div class="wrap"><div class="eyebrow">PROJECT UNVEILED · TRUTH ON TRIAL · POWERED BY TRUST-WORTHY</div><h1><?=h((string)($trial['headline'] ?? 'Truth on Trial'))?></h1><p><?=h((string)($trial['summary'] ?? ''))?></p><div class="manifesto"><strong>The Claim:</strong> <?=h((string)($trial['claim'] ?? ''))?></div></div></section>
