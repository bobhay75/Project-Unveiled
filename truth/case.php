...
$hasBoundCase = isset($caseId) && is_string($caseId);
$requestedCaseId = $hasBoundCase ? $caseId : (isset($_GET['id']) ? (string) $_GET['id'] : '');
...
if (!$hasBoundCase) {
    header('Location: ' . tw_public_path($case), true, 308);
    exit;
}
